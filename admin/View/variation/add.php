...
<body>
    ...
    <div class="ctn">
        <h1>ADD VARIATION</h1>
        <form action="?href=addVariation" method="post" enctype="multipart/form-data">

            <select name="idProduct" id="">
                <?php foreach ($listProduct as $value) : ?>
                    <option value="<?php echo $value['id'] ?>"><img src="../Upload/<?php echo $value['img'] ?>" alt="note" style="width: 20px; border-radius:50%;height: 20px;"><?php echo $value['name'] ?></option>
                <?php endforeach ?>
            </select> <br> <br>
            ...
            <input type="text" name="price" placeholder="PRICE PRODUCT..." class="ip" required> <br><br>
            <input type="text" name="discout" placeholder="DISCOUT PRODUCT..." class="ip" required> <br><br>
            <input type="number" name="quantity" placeholder="QUANTITY PRODUCT..." class="ip" required> <br><br>
            <div class='fileImg'>
